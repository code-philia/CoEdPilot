...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Transform dataset into CoEdPilot prompt format and split into training, validation, and test sets.")
    ...
    print(f"Dataset will be split as follows: Training: {args.train_ratio:.4f}%, Validation: {args.val_ratio:.4f}%, Test: {args.test_ratio:.4f}%")
    main(args)
